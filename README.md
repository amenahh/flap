...
[m1.2024.compilation.info@listes.u-paris.fr](https://listes.u-paris.fr/wws/info/m1.2024.compilation.info). Vous
...
1. "bifurquer" (_forker_, en franglais) ce projet,

2. passer le nouveau projet obtenu en visibilité privée,

3. ajouter vos enseignants (`guatto`, `geoffroy`) comme membres du nouveau
   projet,

4. éditer le fichier [AUTEURS](flap/AUTEURS) pour spécifier les noms et prénoms
   de votre binôme.
